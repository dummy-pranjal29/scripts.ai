...
import { useChatSessions } from "@/modules/ai-chat/hooks/use-chat-sessions";
...
export const AIChatSidePanel: React.FC<AIChatSidePanelProps> = ({
  ...
  const handleSendMessage = async (e: React.FormEvent) => {
    ...
    try {
      const contextualMessage = getChatModePrompt(chatMode, userInput);
      ...
      if (response.ok) {
        ...
        // The API already saves the message to database, no need to add locally
        // The hook will automatically refetch the messages
      } else {
                ...
                <DropdownMenu>
                  ...
                  <DropdownMenuContent align="end">
                    ...
                    <DropdownMenuItem
                      onClick={() => {
                        if (currentSession) {
                          deleteSession(currentSession.id).then(() => {
                  ...
                  <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                      <Button variant="ghost" size="sm" className="h-8 px-3">
                        ...
                        {currentSession?.title?.substring(0, 20) || "New Chat"}
                      </Button>
                    </DropdownMenuTrigger>
